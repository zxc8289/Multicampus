...
<script src="//code.jquery.com/jquery-3.3.1.min.js"></script>
        <div id="hiddnviews">
            ...
            <div id="showTRALER">
                ...
                <iframe id="TRALER" width="100%" height="100%" src="<%=dto.getTrailer() %>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope;  picture-in-picture" allowfullscreen></iframe>
        ...
        <section class="py-5">
            <div class="container1 movie_ex"> 
                <img src="resources<%=dto.getPoster() %>" alt="" class="movie_img">
